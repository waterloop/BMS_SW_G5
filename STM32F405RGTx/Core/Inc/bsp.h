...
// Debug pin macros
#define TURN_ON_DEBUG_PIN() (HAL_GPIO_WritePin(DEBUG_GPIO_Port, DEBUG_Pin, (GPIO_PinState)1))
#define TURN_OFF_DEBUG_PIN() (HAL_GPIO_WritePin(DEBUG_GPIO_Port, DEBUG_Pin, (GPIO_PinState)0))
