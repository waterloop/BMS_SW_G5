...
static void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOA, CONT2_Pin|CS1_Pin|TIMING_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : CONT2_Pin CS1_Pin */
  GPIO_InitStruct.Pin = CONT2_Pin|CS1_Pin;
  ...
  /*Configure GPIO pin : BUTTON_EXT11_Pin */
  GPIO_InitStruct.Pin = BUTTON_EXT11_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_IT_FALLING;
  GPIO_InitStruct.Pull = GPIO_PULLUP;
  HAL_GPIO_Init(BUTTON_EXT11_GPIO_Port, &GPIO_InitStruct);
